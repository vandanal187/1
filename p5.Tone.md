...
Please note p5.Tone.js does not run if p5.sound.js is also included in the HTML header, so it's best to remove or comment out p5.sound.js from the HTML header before running p5.Tone.js.  
